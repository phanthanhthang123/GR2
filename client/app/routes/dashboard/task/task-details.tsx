                ...
                <div className="flex items-center gap-3">
                    ...
                    {task.githubIssueUrl && (
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium px-2 py-1 rounded border border-slate-200/60 transition-colors shrink-0"
                        >
                            <svg className="size-3.5 text-slate-700" viewBox="0 0 16 16" fill="currentColor">
