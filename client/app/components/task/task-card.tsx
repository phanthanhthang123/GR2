        ...
        >
            ...
            <CardContent className='flex flex-col flex-grow'>
                <div className='flex items-start justify-between mb-2'>
                    <div className='font-medium mt-[-20px] flex-grow flex items-center gap-1.5 flex-wrap'>
                        <h4 className='font-medium inline'>{task.title}</h4>
                        {task.githubIssueUrl && (
                            <a
                                ...
                                className="inline-flex items-center gap-1 text-[10px] bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium px-1.5 py-0.5 rounded border border-slate-200/60 transition-colors"
                            >
                                <svg className="size-3 text-slate-700" viewBox="0 0 16 16" fill="currentColor">
